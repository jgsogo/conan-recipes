...
class MagnumConan(ConanFile):
    ...
    def requirements(self):
        ...
        if self.options.sdl2_application and self.settings.os != "Emscripten":
            ...
            self.requires("libalsa/1.2.5.1")  # Override for conflict
    ...
    def package(self):
        ...
        self.copy("*", src=os.path.join(self.package_folder, "share", "magnum"), dst=os.path.join(self.package_folder, "res", "magnum"))
